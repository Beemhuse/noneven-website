      ...
      <header className="xl:px-[150px] p-3">
        <div className="xl:w-3/4 w-full m-auto text-center flex flex-col items-center gap-4">
          <h2 className="xl:text-5xl text-3xl">
            ...
            Growing Productively Agro-based for a Sustainable Nigeria and Global
            Economy
          </h2>
          <p className="xl:text-3xl text-xl">
            Noble Negro Ventures: Your source for many things agricultural from
            farm produce to equipment, real estate, general contract for product
